			...
			Program "fp" {
				...
				SubProgram "d3d11 " {
					...
					void main()
					{
					    u_xlat0 = texture(_MainTex, vs_TEXCOORD0.xy);
					    u_xlat0.x = u_xlat0.w + (-vs_TEXCOORD1.x);
					    u_xlat3.x = (-u_xlat0.w) + vs_TEXCOORD1.z;
					    u_xlatb0 = u_xlat0.x<0.0;
					    if(((int(u_xlatb0) * int(0xffffffffu)))!=0){discard;}
					    ...
					    u_xlat2.xyz = u_xlat0.xzw * u_xlat2.www;
					    u_xlat1 = u_xlat1 + (-u_xlat2);
					    u_xlat0.x = _OutlineWidth * _ScaleRatioA;
					    u_xlat0.x = u_xlat0.x * vs_TEXCOORD1.y;
					    u_xlat6 = min(u_xlat0.x, 1.0);
					    u_xlat0.x = u_xlat0.x * 0.5;
					    u_xlat6 = sqrt(u_xlat6);
					    u_xlat9 = u_xlat3.x * vs_TEXCOORD1.y + u_xlat0.x;
					    u_xlat9 = clamp(u_xlat9, 0.0, 1.0);
					    u_xlat0.x = u_xlat3.x * vs_TEXCOORD1.y + (-u_xlat0.x);
					    u_xlat6 = u_xlat6 * u_xlat9;
					    u_xlat1 = vec4(u_xlat6) * u_xlat1 + u_xlat2;
					    u_xlat3.y = _OutlineSoftness * _ScaleRatioA;
					    u_xlat3.xz = u_xlat3.xy * vs_TEXCOORD1.yy;
					    u_xlat6 = u_xlat3.y * vs_TEXCOORD1.y + 1.0;
					    u_xlat0.x = u_xlat3.z * 0.5 + u_xlat0.x;
					    ...
					    u_xlat0.x = u_xlat0.x * 0.5;
					    u_xlat0.x = (-u_xlat0.x) * vs_TEXCOORD1.y + u_xlat3.x;
					    u_xlatb3 = u_xlat0.x>=0.0;
					    u_xlat3.x = u_xlatb3 ? 1.0 : float(0.0);
					    u_xlat6 = _GlowOuter * _ScaleRatioB + (-_GlowInner);
					    u_xlat3.x = u_xlat3.x * u_xlat6 + _GlowInner;
					    u_xlat3.x = u_xlat3.x * 0.5;
					    u_xlat6 = u_xlat3.x * vs_TEXCOORD1.y + 1.0;
				...
				SubProgram "d3d11 " {
					...
					void main()
					{
					    ...
					    u_xlat0.x = (-u_xlat0.x) + 1.0;
					    u_xlat1 = u_xlat0.xxxx * u_xlat1;
					    u_xlat0.xz = (-_ClipRect.xy) + _ClipRect.zw;
					    u_xlat0.xz = u_xlat0.xz + -abs(vs_TEXCOORD2.xy);
					    u_xlat0.xz = u_xlat0.xz * vs_TEXCOORD2.zw;
					    u_xlat0.xz = clamp(u_xlat0.xz, 0.0, 1.0);
					    u_xlat0.x = u_xlat0.z * u_xlat0.x;
					    u_xlat6 = u_xlat1.w * u_xlat0.x + -0.00100000005;
					    u_xlatb6 = u_xlat6<0.0;
					    if(((int(u_xlatb6) * int(0xffffffffu)))!=0){discard;}
					    u_xlat6 = _GlowOffset * _ScaleRatioB;
					    u_xlat6 = u_xlat6 * vs_TEXCOORD1.y;
					    u_xlat3.x = (-u_xlat6) * 0.5 + u_xlat3.x;
					    u_xlatb6 = u_xlat3.x>=0.0;
					    u_xlat6 = u_xlatb6 ? 1.0 : float(0.0);
					    u_xlat9 = _GlowOuter * _ScaleRatioB + (-_GlowInner);
					    u_xlat6 = u_xlat6 * u_xlat9 + _GlowInner;
					    u_xlat6 = u_xlat6 * vs_TEXCOORD1.y;
					    u_xlat9 = u_xlat6 * 0.5 + 1.0;
					    u_xlat6 = u_xlat6 * 0.5;
					    ...
					    u_xlat3.x = u_xlat3.x * _GlowPower;
					    u_xlat3.x = exp2(u_xlat3.x);
					    u_xlat3.x = (-u_xlat3.x) + 1.0;
					    u_xlat3.x = u_xlat6 * u_xlat3.x;
					    u_xlat3.x = dot(_GlowColor.ww, u_xlat3.xx);
					    u_xlat3.x = clamp(u_xlat3.x, 0.0, 1.0);
					    u_xlat1.xyz = _GlowColor.xyz * u_xlat3.xxx + u_xlat1.xyz;
					    u_xlat0 = u_xlat0.xxxx * u_xlat1;
					    SV_Target0 = u_xlat0 * vs_COLOR0.wwww;
					    return;
					}"
