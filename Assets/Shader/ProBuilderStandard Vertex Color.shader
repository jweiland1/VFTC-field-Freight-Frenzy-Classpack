			...
			Program "fp" {
				...
				SubProgram "d3d11 " {
					...
					void main()
					{
					    ...
					    u_xlat38 = u_xlat5.w * unity_Lightmap_HDR.x;
				...
				SubProgram "d3d11 " {
					...
					void main()
					{
					    ...
					    u_xlat38 = vs_TEXCOORD1.y * vs_TEXCOORD1.y;
					    u_xlat38 = vs_TEXCOORD1.x * vs_TEXCOORD1.x + (-u_xlat38);
				...
				SubProgram "d3d11 " {
					...
					void main()
					{
					    ...
					    u_xlat38 = u_xlat6.w * unity_DynamicLightmap_HDR.x;
					    u_xlat6.xyz = u_xlat6.xyz * vec3(u_xlat38);
					    u_xlat6.xyz = log2(u_xlat6.xyz);
					    u_xlat6.xyz = u_xlat6.xyz * unity_DynamicLightmap_HDR.yyy;
					    u_xlat6.xyz = exp2(u_xlat6.xyz);
				...
				SubProgram "d3d11 " {
					...
					void main()
					{
					    ...
					    u_xlat41 = u_xlat41 * u_xlat42 + u_xlat4.x;
					    u_xlat5.xyz = vec3(u_xlat41) * _LightColor0.xyz;
					    u_xlat6 = texture(unity_Lightmap, vs_TEXCOORD3.xy);
					    ...
					    u_xlat7 = texture(unity_LightmapInd, vs_TEXCOORD3.xy);
					    u_xlat7.xyz = u_xlat7.xyz + vec3(-0.5, -0.5, -0.5);
					    u_xlat41 = dot(vs_TEXCOORD1.xyz, u_xlat7.xyz);
					    ...
					    if(u_xlatb4){
					        ...
					        u_xlat4 = textureLod(unity_SpecCube1, u_xlat17.xyz, u_xlat41);
				...
				SubProgram "d3d11 " {
					...
					void main()
					{
					    ...
					    if(u_xlatb41){
					        ...
					        u_xlat6.x = min(u_xlat4.x, u_xlat41);
					        u_xlat7 = texture(unity_ProbeVolumeSH, u_xlat6.xzw);
					        u_xlat8.xyz = u_xlat6.xzw + vec3(0.25, 0.0, 0.0);
					        u_xlat8 = texture(unity_ProbeVolumeSH, u_xlat8.xyz);
					        u_xlat6.xyz = u_xlat6.xzw + vec3(0.5, 0.0, 0.0);
					    ...
					    u_xlat41 = vs_TEXCOORD1.y * vs_TEXCOORD1.y;
					    u_xlat41 = vs_TEXCOORD1.x * vs_TEXCOORD1.x + (-u_xlat41);
					    u_xlat6.xyz = unity_SHC.xyz * vec3(u_xlat41) + u_xlat8.xyz;
					    ...
					    u_xlat41 = u_xlat7.w * unity_Lightmap_HDR.x;
					    ...
					    u_xlat41 = dot(vs_TEXCOORD1.xyz, u_xlat8.xyz);
					    u_xlat41 = u_xlat41 + 0.5;
			...
			Program "fp" {
				SubProgram "d3d11 " {
					...
					void main()
					{
					    ...
					    u_xlat3.xyz = u_xlat3.xyz * vs_COLOR0.xyz + vec3(-0.220916301, -0.220916301, -0.220916301);
			...
			Program "fp" {
				...
				SubProgram "d3d11 " {
					...
					void main()
					{
					    ...
					    SV_Target2.w = 1.0;
					    u_xlat1 = texture(unity_DynamicLightmap, vs_TEXCOORD4.zw);
					    u_xlat12 = u_xlat1.w * unity_DynamicLightmap_HDR.x;
