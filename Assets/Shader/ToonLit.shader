			...
			Program "fp" {
				SubProgram "d3d11 " {
					...
					void main()
					{
					    ...
					    u_xlat1 = texture(_Ramp, u_xlat1.xx);
				...
				SubProgram "d3d11 " {
					...
					void main()
					{
					    ...
					    u_xlat9 = u_xlat9 + u_xlat9;
					    u_xlat1.xyz = vec3(u_xlat9) * u_xlat1.xyz;
					    u_xlat1.xyz = u_xlat0.xyz * vs_TEXCOORD3.xyz + u_xlat1.xyz;
				...
				SubProgram "d3d11 " {
					...
					void main()
					{
					    ...
					    u_xlat7 = u_xlat1.w * unity_Lightmap_HDR.x;
			...
			Program "fp" {
				SubProgram "d3d11 " {
					...
					void main()
					{
					    ...
					    u_xlat3 = texture(_Ramp, u_xlat0.xx);
					    u_xlat0.xyz = u_xlat1.xyz * _LightColor0.xyz;
					    u_xlat0.xyz = u_xlat3.xyz * u_xlat0.xyz;
					    u_xlat12 = dot(u_xlat2.xx, vec2(u_xlat12));
				...
				SubProgram "d3d11 " {
					...
					void main()
					{
					    ...
					    u_xlat0.x = dot(vs_TEXCOORD1.xyz, u_xlat0.xyz);
					    u_xlat0.x = u_xlat0.x * 0.5 + 0.5;
					    u_xlat2 = texture(_Ramp, u_xlat0.xx);
					    u_xlat0.xyz = u_xlat1.xyz * _LightColor0.xyz;
					    u_xlat0.xyz = u_xlat2.xyz * u_xlat0.xyz;
					    u_xlat12 = dot(vec2(u_xlat13), vec2(u_xlat12));
					    SV_Target0.xyz = vec3(u_xlat12) * u_xlat0.xyz;
					    SV_Target0.w = 1.0;
					    return;
					}"
				...
				SubProgram "d3d11 " {
					...
					void main()
					{
					    ...
					    u_xlat1.x = dot(vs_TEXCOORD1.xyz, _WorldSpaceLightPos0.xyz);
					    u_xlat1.x = u_xlat1.x * 0.5 + 0.5;
					    u_xlat2 = texture(_Ramp, u_xlat1.xx);
					    u_xlat0.xyz = u_xlat0.xyz * _LightColor0.xyz;
					    u_xlat0.xyz = u_xlat2.xyz * u_xlat0.xyz;
					    u_xlat9 = dot(u_xlat1.ww, vec2(u_xlat9));
